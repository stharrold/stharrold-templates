...
"""Deterministic bundle engine: the catalog, dependency resolution, and the
file-ownership rules (template-owned / user-merge / user-skip).

Canonical home (moved from scripts/apply_bundle.py in issue #240). The
argparse CLI stays in scripts/apply_bundle.py and imports this module.
