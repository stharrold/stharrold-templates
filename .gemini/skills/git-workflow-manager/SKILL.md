...
```bash
python .gemini/skills/git-workflow-manager/scripts/generate_work_items_from_pr.py \
  <pr_number>
```
...
python .gemini/skills/git-workflow-manager/scripts/generate_work_items_from_pr.py 94
