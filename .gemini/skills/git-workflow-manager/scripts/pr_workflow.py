...
Usage:
    uv run python .gemini/skills/git-workflow-manager/scripts/pr_workflow.py <step>
...
def main():
    ...
    parser.add_argument("step", choices=["finish-feature", "start-develop", "full", "status"], help="Workflow step to execute")
