...
# Gemini Code Context: workflow-orchestrator
...
- Context detection is built into Gemini Code's capabilities
...
def detect_context():
    ...
    # Use: python .gemini/skills/agentdb-state-manager/scripts/query_workflow_state.py
...
**Gemini Code implements this by:**
```python
import subprocess
...
**Purpose:** Prevent Gemini Code from exceeding context limits
