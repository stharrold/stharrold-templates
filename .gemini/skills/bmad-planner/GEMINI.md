...
# Gemini Code Context: bmad-planner
...
4. Creates planning/<slug>/ directory with GEMINI.md, README.md, ARCHIVED/
...
- Gemini Code manually conducts Q&A
- Gemini Code manually generates requirements.md, architecture.md, epics.md
...
└── <slug>/
    ...
    ├── GEMINI.md           # Context for this planning
    ├── README.md           # Human-readable overview
