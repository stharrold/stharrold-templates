...
- Generate customized README.md, GEMINI.md, pyproject.toml
...
**Copied verbatim:**
- `.gemini/skills/` (all 9 skills including this one)
...
- `GEMINI.md` (customized for new repo context)
...
- GEMINI.md and README.md in each directory
- ARCHIVED/ subdirectories with their own GEMINI.md/README.md
...
Copy workflow system (.gemini/skills/, WORKFLOW.md, etc.)? (Y/n)
> y
...
✓ Copied: .gemini/skills/UPDATE_CHECKLIST.md

ℹ Generating README.md...
✓ Generated README.md

ℹ Generating GEMINI.md...
✓ Generated GEMINI.md
...
Created:
  ...
  ✓ Documentation (WORKFLOW.md, GEMINI.md, CONTRIBUTING.md)
...
Documentation:
  ...
  - WORKFLOW.md - Complete workflow guide
  - GEMINI.md - Gemini Code interaction guide
  - CONTRIBUTING.md - Contributor guidelines
...
- `.gemini/skills/UPDATE_CHECKLIST.md` (393 lines) - Skill update checklist
...
- `GEMINI.md` - Context-specific guidance
- `README.md` - Human-readable documentation
- `ARCHIVED/` subdirectory with its own GEMINI.md and README.md
...
**Workflow system:**
- All `.gemini/skills/` files (SKILL.md, GEMINI.md, scripts, templates)
- `WORKFLOW.md` (workflow is technology-agnostic)
- `CONTRIBUTING.md` (standards apply to all repos)
- `.gemini/skills/UPDATE_CHECKLIST.md` (update process unchanged)
...
- Workflow architecture → from source GEMINI.md (workflow sections)
...
**8 workflow skills:**
- All SKILL.md, GEMINI.md, README.md, CHANGELOG.md files
- All Python scripts and templates
- All ARCHIVED/ directories with documentation

**Complete documentation:**
- Customized README.md and GEMINI.md
...
- Every directory has GEMINI.md, README.md, ARCHIVED/
...
2. Read GEMINI.md (~800 lines → ~600 tokens)
3. Read all 9 skill SKILL.md files (~3,200 lines → ~2,400 tokens)
4. Manually copy .gemini/skills/ directory structure
5. Manually adapt README.md, GEMINI.md, pyproject.toml
...
1. Review generated README.md and GEMINI.md
2. Fill in code architecture section in GEMINI.md
...
- `GEMINI.md` - Replaced with generated GEMINI.md (your content will be lost)
...
**Workflow system:**
- `.gemini/skills/` - Created/merged (existing skills directory will be overwritten)
...
ls -la README.md GEMINI.md CHANGELOG.md pyproject.toml .gitignore
...
python /path/to/source-with-workflow/.gemini/skills/initialize-repository/scripts/initialize_repository.py \
...
cat GEMINI.md        # Review generated GEMINI.md
...
# - Copy workflow sections from test/GEMINI.md to your GEMINI.md
...
git commit -m "feat(workflow): integrate workflow v7x0 system
...
python .gemini/skills/bmad-planner/scripts/create_planning.py test-feature $(git config user.name)
```
...
ls .gemini/skills/  # Should show 9 skills
...
cat .gemini/skills/initialize-repository/templates/.gitignore >> .gitignore.merged
...
- Source repository must have .gemini/skills/ directory
