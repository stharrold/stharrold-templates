...
def copy_commands(source_path: Path, target_path: Path, force: bool) -> int:
    ...
    commands = list(workflow_dir.glob("v7x0_*.md"))
    if not commands:
        print_warning("No v7x0_* workflow commands found in commands/workflow/")
        return 0
...
def print_summary(
    ...
    print('  4. Start v7x0 workflow: /workflow:v7x0_1-worktree "feature description"')
