...
### Scenario 3: CLAUDE.md Updated

**Given**: CLAUDE.md previously referenced TODO system
...
grep -n "TODO Frontmatter" CLAUDE.md
grep -n "archive-todo" CLAUDE.md
grep -n "TODO\*.md YAML" CLAUDE.md

# Should show Gate 5 is AI Config Sync
grep -n "5. AI Config Sync" CLAUDE.md
```
...
**Then**: AGENTS.md matches CLAUDE.md (no TODO references)
...
| No TODO refs in docs | `grep "TODO Frontmatter" CLAUDE.md` | No output |
| AGENTS.md synced | `diff CLAUDE.md AGENTS.md` | Minimal diff (headers only) |
...
# Revert changes
git checkout HEAD -- CLAUDE.md AGENTS.md
git checkout HEAD -- .claude/skills/quality-enforcer/scripts/run_quality_gates.py
```
