...
|------|----------|--------|
| `TODO_template.md` | `.claude/skills/workflow-orchestrator/templates/` | Historical reference |
...
**Location**: `.claude/skills/git-workflow-manager/scripts/pr_workflow.py`
...
```
1. finish-feature → PR feature → contrib
2. sync-agents → Sync CLAUDE.md → AGENTS.md
3. start-develop → PR contrib → develop
```

---

### Entity: CLAUDE.md Sections
