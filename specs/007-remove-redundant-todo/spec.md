...
**Created**: 2025-11-23
**Status**: Draft
**Input**: User description: "Remove redundant TODO*.md system - archive existing files, update quality gates, and update CLAUDE.md since GitHub Issues and Speckit tasks.md now provide superior task tracking"
...
3. **Given** CLAUDE.md references TODO*.md requirements, **When** the update is complete, **Then** no references to TODO*.md frontmatter requirements remain
...
- **FR-003**: System MUST update CLAUDE.md to remove all references to TODO*.md requirements
- **FR-004**: System MUST update AGENTS.md (synced copy) to reflect CLAUDE.md changes
- **FR-005**: System MUST preserve TODO template files in `.claude/skills/workflow-orchestrator/templates/` for historical reference or future use
...
- **CLAUDE.md / AGENTS.md**: AI assistant configuration files - being updated
