...
Document the AI configuration architecture to clarify the relationship between Claude-first development and cross-tool compatibility.
...
1. **CLAUDE.md** - Add "AI Configuration Architecture" section
2. **.claude/CLAUDE.md** - Add PRIMARY source statement
3. **.agents/CLAUDE.md** - Add OpenAI spec reference and compatible tools
