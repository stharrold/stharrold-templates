...
- [ ] T001 Create `.gemini/commands/workflow/all.md` with YAML frontmatter containing description and order fields
...
- [ ] T012 Update GEMINI.md Slash Commands section to include `/workflow/all` with description of modes (new, release, continue, default)

- [ ] T013 [P] Sync GEMINI.md updates to AGENTS.md

- [ ] T014 [P] Sync GEMINI.md updates to .github/copilot-instructions.md
...
T012 → T013, T014 (GEMINI.md before sync)
...
Task: "Sync GEMINI.md updates to AGENTS.md"
Task: "Sync GEMINI.md updates to .github/copilot-instructions.md"
```
