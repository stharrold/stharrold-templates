...
ls -la .gemini/commands/workflow/
...
```bash
# Should NOT exist
ls .gemini/commands/specify.md    # Should fail
ls .gemini/commands/plan.md       # Should fail
ls .gemini/commands/tasks.md      # Should fail
ls .gemini/commands/workflow.md   # Should fail
```
...
### 5. Verify GEMINI.md Updated

```bash
# Check workflow order documentation
grep -A 10 "Slash Commands" GEMINI.md
...
- [ ] GEMINI.md reflects new command names
- [ ] Commands execute correctly in Gemini Code
