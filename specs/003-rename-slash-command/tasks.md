...
- [ ] T002 [P] Create `.claude/commands/workflow/1_specify.md` with:
...
- [ ] T003 [P] Create `.claude/commands/workflow/2_plan.md` with:
...
- [ ] T004 [P] Create `.claude/commands/workflow/3_tasks.md` with:
...
- [ ] T005 [P] Create `.claude/commands/workflow/5_integrate.md` with:
...
- [ ] T006 Create NEW `.claude/commands/workflow/4_implement.md` with:
  - Frontmatter:
    ```yaml
    ---
