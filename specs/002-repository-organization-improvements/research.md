...
- Duplicates much of `.claude/skills/` structure
...
**Rationale**:
- Current: CLAUDE.md + README.md + SKILL.md + CHANGELOG.md = 4 files
...
### RQ-6: README.md vs CLAUDE.md Separation

**Decision**: Create README.md for humans, keep CLAUDE.md for AI

**Rationale**:
- README.md is universal convention for human developers
- CLAUDE.md contains AI-specific instructions and context
...
| README vs CLAUDE | Separate files for different audiences |
