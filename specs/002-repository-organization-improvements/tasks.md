...
- [ ] T016 Create `README.md` at repository root with:
  ...
  - Links to CLAUDE.md, WORKFLOW.md, CONTRIBUTING.md
...
- [ ] T018 Update any CLAUDE.md references to old directory structure
...
- [ ] T021 Run all 6 quality gates: `podman-compose run --rm dev python .claude/skills/quality-enforcer/scripts/run_quality_gates.py`
