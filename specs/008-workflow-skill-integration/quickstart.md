...
```bash
# Initialize AgentDB
podman-compose run --rm dev python .gemini/skills/agentdb-state-manager/scripts/init_database.py
...
grep -r "\.specify/" .gemini/commands/workflow/
...
ls .gemini/skills/workflow-utilities/ARCHIVED/
...
mv .gemini/skills/workflow-utilities/ARCHIVED/*.py .gemini/skills/workflow-utilities/scripts/

# Revert slash commands (git)
git checkout HEAD~1 -- .gemini/commands/workflow/

# Revert script changes
git checkout HEAD~1 -- .gemini/skills/git-workflow-manager/scripts/create_worktree.py
git checkout HEAD~1 -- .gemini/skills/git-workflow-manager/scripts/cleanup_feature.py
```
