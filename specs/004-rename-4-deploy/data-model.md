...
**Description**: Markdown file defining a workflow step in `.gemini/commands/workflow/`
...
**Description**: Python script in `.gemini/skills/git-workflow-manager/scripts/` that automates git operations
...
Usage:
    podman-compose run --rm dev python .gemini/skills/git-workflow-manager/scripts/<script>.py <args>
...
**Description**: Markdown file documenting workflow (GEMINI.md, WORKFLOW.md, etc.)

**GEMINI.md Slash Commands Section**:
```markdown
## Slash Commands
...
**Validation Rules**:
- Must be synced: GEMINI.md → AGENTS.md → .github/copilot-instructions.md
...
|-------------|------------------|
| Slash Commands | `.gemini/commands/workflow/<N>_<name>.md` |
| Workflow Scripts | `.gemini/skills/git-workflow-manager/scripts/<name>.py` |
| Documentation | Root: `GEMINI.md`, `AGENTS.md`, `WORKFLOW.md` |
