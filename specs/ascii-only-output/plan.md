...
**Files:**
- `.gemini/skills/workflow-utilities/scripts/safe_output.py`
...
**Verification:**
```bash
uv run python -c "from .gemini.skills.workflow_utilities.scripts.safe_output import SYMBOLS; print(all(v.isascii() for v in SYMBOLS.values()))"
```
...
**Verification:**
```bash
grep -E '[✓✗→⚠]' .gemini/skills/initialize-repository/scripts/initialize_repository.py || echo "No Unicode found"
```
...
**Verification:**
```bash
grep -E '[✓✗→⚠]' .gemini/skills/bmad-planner/scripts/create_planning.py || echo "No Unicode found"
```
...
**Files:**
- `.gemini/skills/speckit-author/scripts/create_specifications.py`
...
**Verification:**
```bash
grep -E '[✓✗→⚠]' .gemini/skills/speckit-author/scripts/create_specifications.py || echo "No Unicode found"
```
...
**Files:**
- `.gemini/skills/workflow-utilities/scripts/create_skill.py`
...
**Verification:**
```bash
grep -E '[✓✗→⚠]' .gemini/skills/workflow-utilities/scripts/create_skill.py || echo "No Unicode found"
```
...
**Files:**
- `.gemini/skills/agentdb-state-manager/scripts/checkpoint_manager.py`
...
**Verification:**
```bash
grep -E '[✓✗→⚠]' .gemini/skills/agentdb-state-manager/scripts/checkpoint_manager.py || echo "No Unicode found"
```
...
**Files:**
- `.gemini/skills/quality-enforcer/scripts/check_coverage.py`
...
**Verification:**
```bash
grep -E '[✓✗→⚠]' .gemini/skills/quality-enforcer/scripts/check_coverage.py || echo "No Unicode found"
```
...
**Files:**
- `.gemini/skills/quality-enforcer/scripts/run_quality_gates.py`
...
**Verification:**
```bash
grep -E '[✓✗→⚠]' .gemini/skills/quality-enforcer/scripts/run_quality_gates.py || echo "No Unicode found"
```
...
from .gemini.skills.workflow_utilities.scripts.safe_output import *
print_success('test')
print_error('test')
print_warning('test')
"
...
2. Check both `.gemini/skills/` and `.agents/` directories
