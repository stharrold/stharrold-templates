...
**File:** `.gemini/skills/workflow-utilities/scripts/safe_output.py`
...
1. `.gemini/skills/initialize-repository/scripts/initialize_repository.py`
...
2. `.gemini/skills/bmad-planner/scripts/create_planning.py`
   - Lines 346, 486, 601, 605, 827, 878, 902, 918, 952, 976, 1029-1035, 1041, 1072

3. `.gemini/skills/speckit-author/scripts/create_specifications.py`
   - Lines 251, 345, 545, 553, 559, 596, 706, 732

4. `.gemini/skills/workflow-utilities/scripts/create_skill.py`
   - Lines 98, 108, 126, 346, 936, 945-954

5. `.gemini/skills/agentdb-state-manager/scripts/checkpoint_manager.py`
   - Lines 43, 74

6. `.gemini/skills/quality-enforcer/scripts/check_coverage.py`
   - Line 46

7. `.gemini/skills/quality-enforcer/scripts/run_quality_gates.py`
...
**Files:** `.gemini/skills/*/GEMINI.md`, `*.md` in skills directories
...
- Existing implementation: `.gemini/skills/workflow-utilities/scripts/safe_output.py`
