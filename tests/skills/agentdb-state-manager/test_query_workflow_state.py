...
class TestPhaseMap:
    ...
    def test_step_phase_map_entries(self):
        """Verify PHASE_MAP has sN entries with correct next_command."""
        ...
        assert PHASE_MAP["phase_v7x1_1_worktree"][2] == "/workflow:s2-integrate"
        assert PHASE_MAP["phase_v7x1_2_integrate"][2] == "/workflow:s3-release"
        assert PHASE_MAP["phase_v7x1_3_release"][2] == "/workflow:s4-backmerge"
        assert PHASE_MAP["phase_v7x1_4_backmerge"][2] is None

    def test_step_phase_numbers(self):
        """Verify sN steps numbers are sequential 1-4."""
    ...
    def test_step_phase_names(self):
        """Verify sN steps names."""
