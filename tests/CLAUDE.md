...
type: claude-context
directory: tests
purpose: Test suite root with unit, contract, and integration tests.
parent: ../CLAUDE.md
sibling_readme: null
children:
  - contract/CLAUDE.md
...
Test suite root with unit, contract, and integration tests.
...
- **contract**: [contract/CLAUDE.md](contract/CLAUDE.md)
...
**Child Directories:**
- **[contract/CLAUDE.md](contract/CLAUDE.md)** - Contract
- **[integration/CLAUDE.md](integration/CLAUDE.md)** - Integration
