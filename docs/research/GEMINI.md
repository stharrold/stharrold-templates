...
- `18-1_prompt-complexity-routing-gemini-model.md` - Gemini model routing by complexity
- `19_jupyter-to-marimo-conversion-guide.md` - Jupyter to Marimo migration
- `20_gemini-preserve-state-todo-compact.md` - Gemini state preservation patterns
