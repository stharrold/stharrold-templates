...
- **Agentic development paradigm** positioning Gemini Code as autonomous development partner
...
- Position Gemini Code as autonomous development partner, not code completion tool
...
1. **Credential setup**: Complete [../20_credentials/GEMINI.md](../20_credentials/GEMINI.md)
2. **MCP configuration**: Review [../10_mcp/GEMINI.md](../10_mcp/GEMINI.md) for server setup
...
- **Credential management**: [../20_credentials/GEMINI.md](../20_credentials/GEMINI.md)
