...
Model Context Protocol (MCP) setup and configuration for Gemini Code development workflows.
...
3. **[13_context-management.md](./13_context-management.md)** - GEMINI.md workflow optimization patterns
...
- **Implementation patterns**: [../30_implementation/GEMINI.md](../30_implementation/GEMINI.md)
...
- GEMINI.md hierarchical organization
...
2. **Configure credentials** → Follow [../20_credentials/GEMINI.md](../20_credentials/GEMINI.md)
