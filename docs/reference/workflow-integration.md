...
This document covers the synchronization and deployment steps of the v6 workflow.
...
**Command:** `/integrate ["feature/branch-name"]`
...
If you provide the branch name, `/integrate` will:
...
The `/release` command uses semantic versioning (`vMAJOR.MINOR.PATCH`):
