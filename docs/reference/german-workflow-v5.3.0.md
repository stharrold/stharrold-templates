...
- **Location:** `.claude/skills/git-workflow-manager/scripts/workflow:v7x1_4-backmerge_release.py`
...
**Command:**
```bash
python .claude/skills/git-workflow-manager/scripts/workflow:v7x1_4-backmerge_release.py \
  v1.1.0 develop
```
