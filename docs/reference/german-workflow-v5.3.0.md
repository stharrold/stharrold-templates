...
**Version:** 5.3.0
**Date:** 2025-11-08
**Architecture:** Skill-based progressive disclosure with BMAD + SpecKit + Gemini Code + PR Feedback Work-Items
...
- **Location:** `.gemini/skills/git-workflow-manager/scripts/workflow:v7x0_4-backmerge_release.py`
...
├── .gemini/skills/            ← 8 skill modules (including Phase 0 meta-skill)
├── src/                       ← Source code
├── tests/                     ← Test suite
...
1. **Contains GEMINI.md with YAML frontmatter**
   - Context-specific guidance for Gemini Code when working in this directory
   - YAML frontmatter with metadata and cross-references
   - References to sibling README.md, parent GEMINI.md, and all children GEMINI.md

2. **Contains README.md with YAML frontmatter**
   - Human-readable documentation for developers
   - YAML frontmatter with metadata and cross-references
   - References to sibling GEMINI.md, parent README.md, and all children README.md

3. **Contains ARCHIVED/ subdirectory** (except ARCHIVED directories themselves)
   - For storing deprecated items from that directory
   - ARCHIVED/ also has its own GEMINI.md and README.md with YAML frontmatter
...
```
specs/feature-auth/
├── GEMINI.md           ← YAML frontmatter + context guidance
├── README.md           ← YAML frontmatter + documentation
├── ARCHIVED/
│   ├── GEMINI.md       ← YAML frontmatter + archived context
...
- GEMINI.md with YAML frontmatter, purpose, and cross-references
...
To add YAML frontmatter to existing GEMINI.md and README.md files:

```bash
# Preview changes
python .gemini/skills/workflow-utilities/scripts/migrate_directory_frontmatter.py --dry-run

# Apply migration
python .gemini/skills/workflow-utilities/scripts/migrate_directory_frontmatter.py
```
...
✓ View release: https://github.com/user/german/workflow:v7x0_3-releases/tag/v1.1.0
```
...
**Command:**
```bash
python .gemini/skills/git-workflow-manager/scripts/workflow:v7x0_4-backmerge_release.py \
  v1.1.0 develop
```
...
✓ Deleted remote branch: origin/workflow:v7x0_3-release/v1.1.0
...
✓ Pushed tag to origin
✓ View release: https://github.com/user/german/workflow:v7x0_3-releases/tag/v1.3.0-hotfix.1
```
...
# Example output:
#   abc123f Merge pull request #42 from user/workflow:v7x0_3-release/v1.5.1
