...
def step_finish_feature() -> bool:
    ...
    result = run_cmd([
        ...
        '--base', contrib,
        '--fill',
        '--body', f'Feature PR created via workflow automation.\n\n🤖 Generated with [Claude Code](https://claude.com/claude-code)'
    ], check=False)
...
def step_start_develop() -> bool:
    ...
    result = run_cmd([
        ...
        '--base', 'develop',
        '--fill',
        '--body', f'Integration PR: {contrib} → develop\n\nWorkflow steps completed:\n- [x] Quality gates passed\n- [x] TODO archived\n- [x] AI config synced\n\n🤖 Generated with [Claude Code](https://claude.com/claude-code)'
    ], check=False)
...
def main():
    ...
    parser.add_argument(
        'step',
        choices=['finish-feature', 'archive-todo', 'sync-agents', 'start-develop', 'full', 'status'],
