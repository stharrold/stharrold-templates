...
This directory contains deprecated files from the initialize-repository meta-skill that have been superseded by newer versions. Files are archived (not deleted) to preserve history and allow comparison with current implementations.
...
- **[../CLAUDE.md](../CLAUDE.md)** - Current Gemini Code context
