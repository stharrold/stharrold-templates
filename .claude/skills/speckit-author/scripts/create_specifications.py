...
def commit_changes(slug: str, specs_dir: Path, todo_file: Path | None = None,
...
def main():
    ...
    parser.add_argument('--issue', type=int, default=None,
                        help='GitHub Issue number to link (e.g., --issue 42)')
    ...
    spec_md = generate_spec_md(
        ...
        qa_responses, bmad_docs, issue_number=args.issue
    )
