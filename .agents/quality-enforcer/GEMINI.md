---
type: gemini-context
directory: .gemini/skills/quality-enforcer
...
# Gemini Code Context: quality-enforcer
...
```
.gemini/skills/quality-enforcer/
...
**Invocation:**
```bash
python .gemini/skills/quality-enforcer/scripts/check_coverage.py [threshold]
```

**Example:**
```bash
# Check 80% threshold (default)
python .gemini/skills/quality-enforcer/scripts/check_coverage.py 80
