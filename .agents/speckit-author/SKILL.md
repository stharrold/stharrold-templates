...
✓ Created specs/my-feature/GEMINI.md
...
**Location:** `.gemini/skills/speckit-author/scripts/create_specifications.py`
...
4. **Directory Creation**
   ...
   - Generates GEMINI.md and README.md
...
└── <feature-slug>/
    ...
    ├── GEMINI.md        # Context for this spec
...
**Location:** `.gemini/skills/speckit-author/scripts/update_asbuilt.py`
...
python .gemini/skills/speckit-author/scripts/update_asbuilt.py \
...
if current_phase == 4 and current_step == '4.4':
    ...
    result = subprocess.run([
        'python',
        '.gemini/skills/speckit-author/scripts/update_asbuilt.py',
        f'planning/{slug}',
        f'specs/{slug}'
    ], check=True)
