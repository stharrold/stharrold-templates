---
type: gemini-context
directory: .gemini/skills/speckit-author
...
# Gemini Code Context: speckit-author
...
4. Creates specs/<slug>/ directory with GEMINI.md, README.md, ARCHIVED/
...
- Gemini Code reproduces SpecKit functionality each time
- ~2,000-3,000 tokens per feature for Q&A and generation

**After (Callable Tool):**
- Gemini Code calls script once
