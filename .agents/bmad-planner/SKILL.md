...
======================================================================
  ✓ Created planning/my-feature/GEMINI.md
  ✓ Created planning/my-feature/README.md
  ✓ Created planning/my-feature/ARCHIVED/GEMINI.md
...
|----------|-------------|---------|
| **Before (manual):** Gemini Code reproduces BMAD each time | ~2,500 tokens | - |
| **After (callable tool):** Gemini Code calls script | ~200 tokens | ~2,300 tokens (92%) |

### Script Architecture

**Location:** `.gemini/skills/bmad-planner/scripts/create_planning.py`
...
- `create_directory_structure()` - GEMINI.md, README.md, ARCHIVED/
...
Workflow calls:
  python .gemini/skills/bmad-planner/scripts/create_planning.py my-feature stharrold
...
│
├── GEMINI.md         # Context for this planning directory
├── README.md         # Human-readable overview
