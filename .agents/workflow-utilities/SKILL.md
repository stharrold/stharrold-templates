...
# Extract archive
python .gemini/skills/workflow-utilities/scripts/archive_manager.py extract <archive> [output_dir]
```
...
```bash
# Preview changes
python .gemini/skills/workflow-utilities/scripts/sync_manifest.py --dry-run
...
**Location:** `.gemini/skills/workflow-utilities/scripts/vcs/`
...
subprocess.run([
    'python',
    '.gemini/skills/workflow-utilities/scripts/todo_updater.py',
    'TODO_feature_20251022T143022Z_json-validator.md',
    'impl_003',
    'complete',
...
subprocess.run([
    'python',
    '.gemini/skills/workflow-utilities/scripts/workflow_registrar.py',
...
subprocess.run([
    'python',
    '.gemini/skills/workflow-utilities/scripts/workflow_archiver.py',
    'TODO_feature_20251103T143000Z_auth.md',
...
subprocess.run([
    'python',
    '.gemini/skills/workflow-utilities/scripts/sync_manifest.py'
], check=True)
```
