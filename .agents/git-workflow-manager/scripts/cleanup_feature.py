...
def cleanup_feature(slug: str, summary: str = None, version: str = None,
                    project_name: str = None, archive_todo_file: bool = False):
...
"""
    ...
    parser.add_argument(
        '--summary',
        default=None,
        help='Completion summary for archive (required with --archive)'
    )
    parser.add_argument(
        '--version',
        default=None,
