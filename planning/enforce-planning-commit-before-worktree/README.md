# Enforce Planning Commit Before Worktree - Planning Documentation

## Overview

BMAD (Business-Motivated Architecture Design) planning documents for the Enforce Planning Commit Before Worktree feature.
