---
type: gemini-context
directory: planning/enforce-planning-commit-before-worktree
purpose: BMAD planning documents for enforce-planning-commit-before-worktree feature
parent: ../GEMINI.md
...
# Gemini Code Context: enforce-planning-commit-before-worktree Planning

## Purpose

BMAD planning documents for the enforce-planning-commit-before-worktree feature. Created during Phase 1 (Planning) in main repository on contrib branch.

## Directory Structure

```
planning/enforce-planning-commit-before-worktree/
...
1. SpecKit auto-detects this planning directory: `../planning/enforce-planning-commit-before-worktree/`
...
- **[README.md](README.md)** - Human-readable overview of enforce-planning-commit-before-worktree planning

**Child Directories:**
- **[ARCHIVED/GEMINI.md](ARCHIVED/GEMINI.md)** - Archived planning documents
